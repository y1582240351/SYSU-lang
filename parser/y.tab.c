...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_BlockItem = 20,                 /* BlockItem  */
  YYSYMBOL_Stmt = 21,                      /* Stmt  */
  YYSYMBOL_Exp = 22,                       /* Exp  */
  YYSYMBOL_VarDecl = 23,                   /* VarDecl  */
  YYSYMBOL_VarDef = 24,                    /* VarDef  */
  YYSYMBOL_BType = 25                      /* BType  */
};
...
{
       0,    86,    86,    93,   100,   114,   116,   118,   120,   127,
     136,   138,   142,   188
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_L_BRACE", "T_R_BRACE", "T_L_SQUARE", "T_R_SQUARE", "T_COMMA",
  "$accept", "CompUnit", "FuncDef", "Ident", "Block", "BlockItem", "Stmt",
  "Exp", "VarDecl", "VarDef", "BType", YY_NULLPTR
};
...
{
       0,    13,     0,     2,     3,     0,     1,     5,    12,     0,
       0,    11,     0,     0,     4,     0,     6,     0,     8,    10,
       0,     7,     9
};
...
{
      15,     1,     6,     7,    11,    16,    10,    19,     0,    12,
       0,    13,    22,     0,    21
};

static const yytype_int8 yycheck[] =
{
       6,     5,     0,     4,     7,    11,     8,     3,    -1,     9,
      -1,    10,     7,    -1,    11
};
...
{
       0,     5,    16,    17,    23,    25,     0,     4,    18,    24,
       8,     7,     9,    10,    19,     6,    11,    20,    21,     3,
      22,    11,     7
};
...
#line 1247 "y.tab.c"
  ...
  case 4: /* FuncDef: BType Ident T_L_PAREN T_R_PAREN Block  */
#line 100 "parser.y"
                                               {
  auto inner = stak.back();
  stak.pop_back();
...
#line 1263 "y.tab.c"
  ...
  case 5: /* Ident: T_IDENTIFIER  */
#line 114 "parser.y"
                    {}
#line 1269 "y.tab.c"
    break;

  case 6: /* Block: T_L_BRACE T_R_BRACE  */
#line 116 "parser.y"
                           {}
#line 1275 "y.tab.c"
    break;

  case 7: /* Block: T_L_BRACE BlockItem T_R_BRACE  */
#line 118 "parser.y"
                                     {}
#line 1281 "y.tab.c"
    break;
...
#line 1292 "y.tab.c"
  ...
  case 9: /* Stmt: T_RETURN Exp T_SEMI  */
#line 127 "parser.y"
                          {
  auto inner = stak.back();
  stak.pop_back();
...
#line 1303 "y.tab.c"
  ...
  case 10: /* Exp: T_NUMERIC_CONSTANT  */
#line 136 "parser.y"
                        {}
#line 1309 "y.tab.c"
    break;

  case 11: /* VarDecl: BType VarDef T_SEMI  */
#line 138 "parser.y"
                             {
...
#line 142 "parser.y"
  ...
  stak.pop_back();
  auto var = llvm::json::Object{{"type", "null"},
                                {"Ident", Ident.get("value")}};
  stak.push_back(llvm::json::Object{"VarDef", llvm::json::Array{var}});
}
#line 1329 "y.tab.c"
    break;
